      ...
      screens.forEach((screen) => {
        ...
        marker.bindPopup(`
          <div style="font-family:'Open Sans',sans-serif;min-width:200px">
            ...
            <a href="/screens/${screen.id.replace(/:/g, '~')}" style="display:block;margin-top:10px;text-align:center;padding:7px;background:#3B47F0;color:white;border-radius:8px;font-size:12px;font-weight:600;text-decoration:none">Xem chi tiết →</a>
          </div>
        `)
